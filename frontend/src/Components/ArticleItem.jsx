...
export default ({article, uid, like}) => <div className="article-item box">
    ...
    <Link to={'/blog/' + article.slug + '/'} className="picture">
        ...
        <Social social={{likes: article.cnt_likes, views: article.cnt_views, comments: article.cnt_comments}} id={article.id} uid={uid} like={like} key={"social-" + article.id}/>
    </Link>
